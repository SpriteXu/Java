...
<body style="background-color:#F2F2F2; padding-top:15px;padding-left:15px;padding-bottom:0px;">
	<div class="layui-card" style="width: 580px; height: 195px;float:left;">
		<div class="layui-card-header">发货管理</div>
              ...
              <div class="layadmin-backlog" lay-anim="" lay-indicator="inside" lay-arrow="none" style="width: 100%; height: 80px;">
                    <li class="layui-col-xs6">
                      <a class="layadmin-backlog-body">
                        <h3>总订单量</h3>
                        <p><cite style="line-height:45px;color:#ff0000" id="totalOrder" ></cite></p>
                      </a>
                    </li>
                    <li class="layui-col-xs6" >
                    	<a class="layadmin-backlog-body" > 
	                        <h3 >待发货</h3>
	                        <p><cite style="line-height:45px;color:#ff0000 " id="toDoOrder" ></cite></p>
                        </a>
                    </li>
                </div>
		</div>
	</div>
	<div class="layui-card" style="width: 650px; height: 195px;float:left;margin-left:15px;">
		<!-- <div class="layui-card-header">热门商品浏览量</div> -->
		<div class="layui-card-body" id="hot" style="width: 560px; height:180px;"></div>
	</div>
	<div class="layui-card" style="width: 580px; height: 310px;float:left;">
		<div class="layui-card-header">销量走势图</div>
		<div class="layui-card-body" id="order" style="width: 480px; height: 260px;"></div>
	</div>
	<div class="layui-card" style="width: 650px; height: 310px;float:left;margin-left:15px;">
		<div class="layui-card-header">乐器销量排行</div>
