...
<!-- 这是开关抽屉式边栏的按钮 -->
<button class="uk-button uk-button-primary uk-button-large" data-uk-offcanvas="{target:'#my-id'}" style="position:fixed;top:115px;left:0px" >展开导航</button>

<!-- 抽屉式边栏 -->
<div id="my-id" class="uk-offcanvas" style="z-index:12">
    <div class="uk-offcanvas-bar" >		
    <ul class="nav nav-sidebar" style="position:relative;top:150px;width:280px;" >
	...
	<div class="container-fluid">
		<div class="row">
			<!-- 控制栏 -->
				...
				<%-- 
			<div class="col-sm-3 col-md-2 sidebar sidebar-1 uk-h4" style="top:120px;font-family:楷体;">
			...
			<!-- 控制内容 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-1 main" style="top:100px;">
				<div class="col-md-12">
					<hr />
					<h1>
						<a name="section1" class="uk-h2">收藏中心</a>
					</h1>
					<hr />
				...
				<div class="col-md-12" >
					<h1>
						<a name="section2" class="uk-h2">我的订单</a>
					</h1>
					<hr />
				...
				<div class="col-md-12">
					<hr />
					<h1>
						<a name="section3" class="uk-h2">地址管理</a>
					</h1>
					<hr />
				...
				<div class="col-md-12">
					<h1>
						<a name="section4" class="uk-h2">猜你喜欢</a>
					</h1>
					<hr />
				...
				<div class="col-md-12">
					<h1>
						<a name="section5" class="uk-h2">账户安全</a>
					</h1>
					<hr />
						...
						success : function(arr) {
							...
							for (var i = 0; i < arr.length; i++) {
								if ((i + 1) % 4 != 0) {
									...
									str = str
											+ "<li class='brick4444'><a href='goods/detail?goodsId="
											+ arr[i].guessGoods.goodsId
											+ "'>"
											+ "<img style='margin-bottom:2px;margin-top:10px;' src='upload/"+arr[i].guessGoods.goodsImg+"' /><p class='goods-title'>"
											+ arr[i].guessGoods.goodsName
