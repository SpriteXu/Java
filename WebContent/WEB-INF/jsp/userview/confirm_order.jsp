...
<body>
	...
	<!-- 中间内容 -->
	<div class="container-fluid bigHead" style="position:relative;top:80px">
			...
			<form id="orderForm" action="order/takeOrder" method="post">
				...
				<table class="table table-hover center" id="shoppingCarTable">
					...
					<c:forEach items="${cartList }" var="c">
						<tr>
							...
							<td><img style="height:100px;" src="upload/${c.cartGoods.goodsImg }" /></td>
				...
				<div class="row">
					...
					<button type="button"
						...
						onclick="confirmPre()">提交订单</button>
				</div>
			</form>
			</div>
		</div>
