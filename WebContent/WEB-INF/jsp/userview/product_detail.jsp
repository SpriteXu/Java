...
<body style="background-color:white;position:relative;top:50px;">
		...
		<div class="row clearfix" style="margin-bottom:50px;">
			...
			<div class="col-md-5 column">
				<dl class="dl-horizontal">
					<dt><span class="badge" style="color:#000">${requestScope.goods.goodsPrice}元</span></dt>
					<dd><span class="badge" style="color:#000">乐器分类：${requestScope.goods.goodsMemory.memoryName }</span></dd>
					<dt><span class="badge" style="color:#000">颜色：${requestScope.goods.goodsColor }</span></dt>
					<dd><span class="badge" style="color:#000">${requestScope.goods.goodsDesc}</span></dd>
					<dt><span class="badge" style="color:#000">购买数量</span></dt>
					<dd><div style="height: 38px;padding-left:10px;padding-top:5px;">
									<button id="redbtn" class="layui-btn layui-btn-radius layui-btn-warm layui-btn-sm"  onclick="reduceCounts()"
									...
									<button id="addbtn" onclick="addCounts()" class="layui-btn layui-btn-radius layui-btn-warm layui-btn-sm"
										style="float: left;">+</button>
								</div></dd>
					<dt style="padding-top:20px;"><button
							class="layui-btn layui-btn-lg layui-btn-radius layui-btn-warm"
							onclick="addToCart()">
							<i class="layui-icon">&#xe608;</i>加入购物车
						</button></dt>
					<dd style="padding-top:20px;padding-left:10px;width:320px;">
					<button	class="layui-btn layui-btn-lg layui-btn-radius layui-btn-warm" id="fav"
							onclick="addToFavorite()">
							<i class="layui-icon">&#xe600;</i>收藏
					</button>
					<button	class="layui-btn layui-btn-lg layui-btn-radius layui-btn-warm" id="unfav"
